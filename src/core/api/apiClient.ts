...
const DEPLOYED_API_BASE_URL = 'https://noise-monitoring-backend.onrender.com';

const DEV_API_PORT = '10001';
...
const getFallbackBaseUrls = (): string[] => {
    ...
    urls.add(DEPLOYED_API_BASE_URL);
    ...
    if (Platform.OS === 'web') {
        ...
        urls.add('http://localhost:10001');
        urls.add('http://127.0.0.1:10001');
